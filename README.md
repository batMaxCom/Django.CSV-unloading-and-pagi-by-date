...
1. (Выполнено)[Выгрузка каталога товаров из csv-файла с сохранением всех позиций в базе данных](./work_with_database)

Дополнительные задания:

1. (Выполнено)[Делаем онлайн-библиотеку](./models_list_displaying)
